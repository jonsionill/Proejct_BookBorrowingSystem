...
public static addbook add;
public static addcopy copy;
public static addcopy1 copy1;
public static editcopy edit1;
public static editbook edit;
    ...
    a.gridx = 0;
    a.gridy = 0;
    BookPanel.add(edit, a);
    a.gridx = 0;
    a.gridy = 0;
    BookPanel.add(copy, a);
    a.gridx = 0;
    a.gridy = 0;
   BookPanel.add(copy1, a);
    a.gridx = 0;
    a.gridy = 0;
   BookPanel.add(edit1, a);
    add.setVisible(true);
 ...
 public void records(){
  ...
  void tbheader(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(BookPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 50, 1140, 210));
    ...
    try {
              ...
              while(BookBorrowingSystem.rst.next()){
                       ...
                       editbook.title.setText(BookBorrowingSystem.rst.getString("title"));
                       editbook.author.setText(BookBorrowingSystem.rst.getString("author"));
                       editbook.edition.setText(BookBorrowingSystem.rst.getString("edition"));
                       editbook.isbn.setText(BookBorrowingSystem.rst.getString("isbn"));
                       editbook.mat_type.setSelectedItem(BookBorrowingSystem.rst.getString("material_type"));
                       editbook.copyright.setYear(BookBorrowingSystem.rst.getInt("copyright"));
                       editbook.place_pub.setText(BookBorrowingSystem.rst.getString("place_publisher"));
                       editbook.pages.setText(BookBorrowingSystem.rst.getString("pages"));
                       editbook.price.setText(BookBorrowingSystem.rst.getString("price"));
    ...
    private void btn_deleteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_deleteMousePressed
        ...
        try {
                int ask = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this copy?", "Message", JOptionPane.YES_NO_OPTION );

                if(ask==JOptionPane.YES_OPTION){

                    BookBorrowingSystem.stm.executeUpdate("Delete from tb_bookcopy where accession_no= '" + hint.getText() + "'");

                       tblmodel.setRowCount(0);
                       records();
                     try {
            BookBorrowingSystem.stm = BookBorrowingSystem.con.createStatement();
            BookBorrowingSystem.rst = BookBorrowingSystem.stm.executeQuery("select count(accession_no) from tb_bookcopy");
            while(BookBorrowingSystem.rst.next()){
