...
public class addpatron extends javax.swing.JPanel {
...
SimpleDateFormat sysdate = new SimpleDateFormat("yyyy-MM-dd");                 
        try{
           String aduser[]= new String[7];
           aduser[0]=plname.getText();
           aduser[1]=pfname.getText();
           aduser[2]=pmname.getText();
           aduser[3]=paddress.getText();
           aduser[4]=sysdate.format(pbirthdate.getDate());
           aduser[5]=pcontact.getText();
           aduser[6]=pemail.getText();
           Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_bbsystem","root","");
           PreparedStatement ps = conn.prepareStatement("insert into tb_patron( patron_lname, patron_fname, patron_mname, address, birthdate, contact_no, email_add, date_membership) values(?,?,?,?,?,?,?,NOW())");
