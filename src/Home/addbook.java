...
public static DefaultTableModel tblmodel = new DefaultTableModel();
 ...
 public ImageIcon ResizeImage(String ImagePath, byte[] pic){
     ...
     Image newImg = img.getScaledInstance(addbook.addimg.getWidth(), addbook.addimg.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                addcopy.titlee.setText(title.getText());
                addcopy.authorr.setText(author.getText());
                 BookForm.add.setVisible(false);
                 BookForm.copy1.setVisible(false);
                 BookForm.copy.setVisible(true);                 
